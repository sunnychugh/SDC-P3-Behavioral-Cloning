...
#from project3_model1 import cropImage, resizeImage, rgb2yuv
#########          reduce & crop & resize & rgb2yuv functions        #############

import random
import cv2
def reducedNoOfImagesPaths(imagesPaths, quantity):
    imagesPaths = random.sample(imagesPaths, quantity)
    return imagesPaths
